...
A* works on the intuiton that you IDENTIFY the nodes/states you would want to explore in well defined environment. 
It would then evaluate the best possible node that it can expand to/ step on to. (By comparing the f value which is simply 
What it needs? 
